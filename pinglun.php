...
else
{
    ...
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <form name="form2" method="post" action="pingjia_del.php">
            <tr #E7F3FB>
                <td height="20" colspan="2"><div align="center" >用户评论</div></td>
            </tr>
            <tr>
                <td height="40" colspan="2" bgcolor="#E7F3FB"><table width="750" height="45" border="0" align="center" cellpadding="0" cellspacing="1">
                        <tr>
                            ...
                            <td width="87" bgcolor="#FFFFFF"><div align="center">查看</div></td>
                        </tr>
                        <?php
                        $pagesize=20;
                        if ($total<=$pagesize){
                        ...
                        while($info1=mysql_fetch_array($sql1))
                        {
                            ...
                            <tr>
                                ...
                                <td height="20" bgcolor="#FFFFFF"><div align="center"><a href="pinglun_view.php?id=<?php echo $info1[id];?>">查看</a></div></td>
                ...
                <td width="657" height="20">
                    <div align="left">
                        ...
                        if($page>=2)
                        {
                            ...
                            <a href="pinglun.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
                            <?php
                        }
                        if($pagecount<=4){
                            ...
                            for($i=1;$i<=4;$i++){
                                ...
                                <a href="pinglun.php?page=<?php echo $i;?>"><?php echo $i;?></a>
                            <?php }?>
                            <a href="pinglun.php?page=<?php echo $page-1;?>" title="后一页"><font face="webdings"> 8 </font></a>
                            <a href="pinglun.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
                        <?php }?>
