...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="30" bgcolor="#E7F3FB"><div align="center">订单查询</div></td>
        </tr>
        <tr>
			  ...
			  <table width="700" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
			   <script language="javascript">
				...
				<tr>
                  ...
                  下订单人姓名:<input type="text" name="username" class="inputcss" size="25" >
 ...
 <input name="button" type="submit" class="buttoncss" id="button" value="查 找">
	    ...
	    if($_POST[show_find]!="")
		 {
		  ...
		  if($username=="")
		   {
		       $sql=mysql_query("select * from orders where dingdanhao='".$ddh."'",$conn);
		   }
		  elseif($ddh=="")
		  {
		  ...
		  {
		      $sql=mysql_query("select * from orders where xiadanren='".$username."'and dingdanhao='".$ddh."'",$conn);
		  }
	  ...
	  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="30" bgcolor="#E7F3FB"><div align="center" >查询结果</div></td>
        </tr>
        <tr>
          <td height="50" bgcolor="#555555"><table width="700" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
