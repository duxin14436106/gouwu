...
<body topmargin="0" leftmargin="0" bottommargin="0">
 <?php
	   ...
	   $sql=mysql_query("select count(*) as total from liuyan  ",$conn);
...
<form name="form1" method="post" action="guest_del.php">
  ...
  <tr>
    <td height="40" colspan="2" bgcolor="#E7F3FB"><table width="750"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <?php
		   ...
		   if ($total<=$pagesize){
			...
			if(($_GET[page])==""){
			 ...
			 $sql1=mysql_query("select * from liuyan order by time desc limit ".($page-1)*$pagesize.",$pagesize ",$conn);
        ...
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF"><div align="center"><a href="guest_edit.php?id=<?php echo $info1[id];?>">查看</a></div></td>
          <td height="20" bgcolor="#FFFFFF"><div align="center">
  ...
  <tr>
	...
	&nbsp;本站共有用户留言&nbsp;<?php
		...
		<a href="lookliuyan.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
        <?php }?>
