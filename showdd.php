...
<table width="700"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div align="center" class="sure-dd">恭喜<?php echo $_SESSION[username];?>您已成功的提交了此订单!详细信息如下:</div></td>
  </tr>
  <tr>
    <td height="20"><div align="left"><span class="style5">订单号：</span><?php echo $ordershao;?></div></td>
  </tr>
  <tr>
...
<table width="500" height="60" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#59c3ea"><table width="500" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr bgcolor="#59c3ea">
        <td width="153" height="30"><div align="center">商品名称</div></td>
        <td width="80"><div align="center">市场价</div></td>
        <td width="80"><div align="center">会员价</div></td>
        <td width="80"><div align="center">数量</div></td>
        <td width="101"><div align="center">小计</div></td>
      </tr>
	  <?php
	  $total=0;
